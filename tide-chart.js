...
class TideChart {
  constructor(stationId) {
    ...
    var tideDataUrl = "https://mussel-rock-cors-proxy.herokuapp.com/https://tidesandcurrents.noaa.gov/api/datagetter?product=predictions&application=NOS.COOPS.TAC.WL&begin_date="
